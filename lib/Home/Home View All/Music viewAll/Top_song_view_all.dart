...
class TopSongsViewAll extends StatefulWidget {

  const TopSongsViewAll({super.key, });

  @override
  State<TopSongsViewAll> createState() => _SongsDeatilsListState();
}

class _SongsDeatilsListState extends State<TopSongsViewAll> {
  ...
  List<TopHindiSongs> filteredItems = [];


  @override
  void initState() {
    super.initState();
    filteredItems = List.from(tophindiSongs);
  ...
  void filterItems(String query) {
    if (query.isEmpty) {
      ...
      setState(() {
        filteredItems = tophindiSongs.where((item) {
