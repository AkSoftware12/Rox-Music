...
class PunjabiViewAll extends StatefulWidget {

  const PunjabiViewAll({super.key, });

  @override
  State<PunjabiViewAll> createState() => _SongsDeatilsListState();
}

class _SongsDeatilsListState extends State<PunjabiViewAll> {
  ...
  List<PunjabiSongs> filteredItems = [];


  @override
  void initState() {
    super.initState();
    filteredItems = List.from(punjabiSongs);
  ...
  void filterItems(String query) {
    if (query.isEmpty) {
      ...
      setState(() {
        filteredItems = punjabiSongs.where((item) {
