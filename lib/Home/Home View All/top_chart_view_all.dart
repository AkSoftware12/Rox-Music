...
class TopChartViewAll extends StatefulWidget {

  const TopChartViewAll({super.key, });

  @override
  State<TopChartViewAll> createState() => _SongsDeatilsListState();
}

class _SongsDeatilsListState extends State<TopChartViewAll> {
  ...
  List<TopChartSongs> filteredItems = [];


  @override
  void initState() {
    super.initState();
    filteredItems = List.from(topchartSongs);
  ...
  void filterItems(String query) {
    if (query.isEmpty) {
      ...
      setState(() {
        filteredItems = topchartSongs.where((item) {
