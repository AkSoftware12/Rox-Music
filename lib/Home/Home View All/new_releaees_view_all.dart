...
class NewReleasseViewAll extends StatefulWidget {

  const NewReleasseViewAll({super.key, });

  @override
  State<NewReleasseViewAll> createState() => _SongsDeatilsListState();
}

class _SongsDeatilsListState extends State<NewReleasseViewAll> {
  ...
  List<NewReleasseSongs> filteredItems = [];


  @override
  void initState() {
    super.initState();
    filteredItems = List.from(newReleasseSongs);
  ...
  void filterItems(String query) {
    if (query.isEmpty) {
      ...
      setState(() {
        filteredItems = newReleasseSongs.where((item) {
